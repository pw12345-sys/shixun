package com.example.administrator.shopp;
...
public class ShopActivity extends Activity implements View.OnClickListener{
    ...
    //商品名称与价格数据集合
    private String[] titles = {"小米手机", "Apple iPhone 11","华为荣耀","8848钛金板手机"};

    private String[] prices = {"3999元", "5999元", "1499元","4999元"};

    private int[] icons = {R.drawable.xiaomi,R.drawable.apple,R.drawable.huawei,R.drawable.tai};
